...
# OpenStreetMap Japan Activityes and others
...
- OSS Contribution: MapLibre GL JS, OpenLayers-ext, OpenMapTiles, Redmine Plugin and React Native Libraries
...
- MappyHour is a online mapping party in Japan
...
- She hosts OpenSource Conference Hokkaido booth in this year.
  - Also Sakanoshita-san and I join to the booth.
- Sakanoshita-san and Hokkosha-san run a mapping party in Hokkaido.
...
- I generate vector tile data with Planetiler.
...
- nyampire create some tiles with aerial photo.
...
- Overpass server in Japan.
  - We provide Overpass API for Global.
  - We provide Overpass Turbo for Global.
  - Currently the server has no limit.
